    ...
    TExtensions: Send + Sync + 'static,
{
        ...
        Fut: Future<Output = EventCallbackResult<()>> + Send + 'static,
    {
        let csv = AsyncCsvAppender::new(
            r"/Users/leopat/Documents/work/taiko-reth-fork/driver/generated_csv/RocketPoolETH/rocketpooleth-approval.csv",
        );
        if !Path::new(r"/Users/leopat/Documents/work/taiko-reth-fork/driver/generated_csv/RocketPoolETH/rocketpooleth-approval.csv").exists() {
    ...
    TExtensions: Send + Sync + 'static,
{
    ...
    {
        let csv = AsyncCsvAppender::new(
            r"/Users/leopat/Documents/work/taiko-reth-fork/driver/generated_csv/RocketPoolETH/rocketpooleth-transfer.csv",
        );
        if !Path::new(r"/Users/leopat/Documents/work/taiko-reth-fork/driver/generated_csv/RocketPoolETH/rocketpooleth-transfer.csv").exists() {
